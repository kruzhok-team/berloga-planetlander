...
float __attribute__((export_name("_ShipGetX"))) ShipGetX() { return s.r.x; }

float __attribute__((export_name("_ShipGetY"))) ShipGetY() { return s.r.y; }

float __attribute__((export_name("_ShipGetVY"))) ShipGetVY() { return s.v.y; }
