      ...
      text: [
        {
          ...
          text: "Привет, пилот! Я капитан Сайда, буду помогать тебе и направлять на миссии. А это бортовой компьютер, будет сопроваждать тебя на миссиях",
        },
        {
      ...
      text: [
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Здесь, на Берлоге, гравитация сильнее, чем на Тетисе, но легче, чем на Цетосе, так что будь готов, пилот. Тебе нужно доставить груз на соседнюю площадку.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
        ...
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Гравитация на Берлоге — 0.9 м/с². На Тетисе - 0.4 м/с², а на Цетосе - 2.7 м/с². Гравитация прямопропорционально зависит от массы планеты. Она постоянно тянет корабль вниз, и тебе потребуется больше тяги двигателя, чтобы компенсировать её.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
    ...
    },
    {
      ...
      text: [
        ...
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Это из-за ускорения. Гравитация увеличивает нагрузку на двигатель. Используй короткие импульсы тяги и разгоняйся постепенно.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
      ...
      text: [
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Здесь гравитация сильнее, чем на Берлоге. Это помешает тебе маневрировать так же, как на Берлоге.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
        ...
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Гравитация на Цетосе — 2.7 м/с². Это означает, что сила, тянущая корабль вниз, уменьшилась, и ты можешь легче корректировать траекторию.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
          text: "Но, наверное, это же делает торможение более тяжелым?",
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Именно. На планетах с высокой гравитацией корабль при движении вниз ускоряется сильнее. Планируй остановки заранее.",
        },
        {
          character: "Капитан Сайда",
