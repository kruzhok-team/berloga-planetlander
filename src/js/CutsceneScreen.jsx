      ...
      text: [
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Здесь гравитация сильнее, чем на Берлоге. Это усложнит маневрирование, ошибок допускать нельзя.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
          text: "Чувствую, что корабль стал тяжелее управляться. Почему так?",
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Гравитация на Цетосе — 2.7 м/с². Это означает, что сила, тянущая корабль вниз, увеличилась, и теперь сложнее корректировать траекторию.",
        },
        {
          character: "Капитан Сайда",
      ...
      text: [
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Дальше нас ждёт испытание на мастерство. Нужно доставить груз через горный хребет на Берлоге. Будь внимателен, пилот.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
          text: "Горный хребет? Значит, придётся маневрировать между склонами?",
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Именно. На высоте ветер становится сильнее, а из-за плотности атмосферы нужно аккуратнее управлять скоростью. Помни: чем выше скорость, тем сложнее сделать резкий манёвр.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
          text: "Понял. Придётся немного замедлиться.",
        },
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Скорость — ключ, но не забывай о топливе. Балансируй между манёвренностью и расходом ресурсов. Ты справишься!",
        },
      ],
    },
    {
      ...
      text: [
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Мы отправляемся на Тетис, но тебе предстоит сложная миссия — доставить груз через зону с сильными восходящими потоками воздуха. Двигайся осторожно.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
          text: "Восходящие потоки? Они могут подтолкнуть корабль вверх?",
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Точно. Потоки создают подъемную силу, которая временно снижает гравитационное воздействие. Используй их для экономии топлива, но будь осторожен: они могут выбить тебя из курса.",
        },
        {
          character: "Пилот",
          imageUrl: "./images/pilot.png",
          text: "Интересно... Значит, я могу компенсировать тягу, используя эти потоки?",
        },
        {
          character: "Бортовой компьютер",
          imageUrl: "./images/bort.png",
          text: "Да. Ориентируйся на индикатор потоков на панели приборов. Это поможет избегать резких рывков.",
        },
        {
          character: "Капитан Сайда",
          imageUrl: "./images/captain.png",
          text: "Справишься, пилот. Эти миссии проверяют не только твои навыки, но и умение адаптироваться. Удачи!",
        },
      ],
    },
  ];
